...
<template>
  <div id="home" class='container'>
    ...
    <div class="row" style="margin-top: 5em;">
          ...
          <img src="../assets/Book.png" width="50%" />
					<h1 id="fh5co-logo" class="cursive-font text-dark font-weight-bold">Online Library!</h1>
				</div>
			</div>
      <br>
      <div class="row">
				<div class="col-md-6 col-sm-6">
					<div class="intro">
						<h2 class="cursive-font text-dark">A online book Library for Freebie Students.</h2>
            <h3 class="cursive-font text-dark">Books are packed with knowledge, insights into a happy life, life lessons, love, fear, prayer and helpful advice. One can read about anything under the sun. Books have been here for centuries and without them today's knowledge of our past ancestors, cultures and civilizations would have been impossible</h3>
						<h2 class="cursive-font text-dark">Come On! Imporove your skills!</h2>
            <p>
							<a href="#" class="btn btn-primary btn-lg btn-hardbound">Checkout Books</a>
						</p>
					</div>
				</div>
				<div class="col-md-6 col-sm-6">
					<figure class="fh5co-intro-img">
						<img class="img-1 animate-box" src="../assets/book_black.png">
						<!-- <img class="img-2 animate-box" src="../assets/book_white.png" alt="Free Website Template by FreeHTML5.co"> -->
					</figure>
				</div>
			</div>
  </div>
